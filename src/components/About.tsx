    ...
    <section id="about" className="py-20 bg-slate-50" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <p className={`text-lg text-slate-700 leading-relaxed transition-all duration-700 delay-200 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {about.description}
          </p>
        </div>

        <div className="mb-16">
          <h3 className={`text-3xl font-bold text-center mb-12 text-slate-900 transition-all duration-700 delay-300 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            What I'm Doing
          </h3>
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {about.interests.map((interest, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group bg-white p-6 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-semibold mb-2 text-slate-900">{interest.title}</h4>
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className={`text-3xl font-bold text-center mb-12 text-slate-900 transition-all duration-700 delay-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Technical Skills
          </h3>
