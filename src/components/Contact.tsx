    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <p
            className={`text-center text-xl text-slate-300 mb-12 transition-all duration-700 delay-200 ${
              isInView
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <a
              ...
              className={`group bg-white/10 backdrop-blur-sm p-6 rounded-2xl hover:bg-white/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ${
                isInView
            ...
            >
              <div className="flex flex-col items-center text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">{personalInfo.phone}</p>
                </div>
              </div>
            </a>

            <div
              className={`group bg-white/10 backdrop-blur-sm p-6 rounded-2xl transition-all duration-300 ${
                isInView
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 translate-x-10"
              }`}
          ...
          <div
            className={`flex justify-center gap-6 transition-all duration-700 delay-600 ${
              isInView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
