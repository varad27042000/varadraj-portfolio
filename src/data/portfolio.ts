...
export const experience = [
...

  {
    ...
    achievements: [
      ...
      // "Integrated AI-powered analytics and intelligent data visualization tools into client-facing dashboards, enabling real-time insights and reducing manual data interpretation time by 45%, significantly improving decision-making efficiency.",
    ],
  },
